...
| TS002  | Implementar visualización de datos en gráficos para reportes ambientales | Como developer, necesito implementar gráficos en los reportes ambientales para mostrar las tendencias de temperatura y humedad, facilitando la visualización de datos históricos. | - **Escenario 1:** Generación de gráfico exitoso <br>   **Dado** que se solicita un reporte de condiciones ambientales, <br>   **Cuando** el sistema genera el reporte, <br>   **Entonces** debe incluir un gráfico de línea que muestre los datos históricos de temperatura y humedad. <br> - **Escenario 2:** Error en generación de gráfico <br>   **Dado** que faltan datos necesarios para el gráfico, <br>   **Entonces** el sistema debe omitir el gráfico y devolver el reporte con un mensaje informativo. | EP07   |
| TS003  | Configuración del almacenamiento de datos históricos de plagas   | Como developer, necesito configurar la base de datos para almacenar el historial de detección de plagas, incluyendo fecha, ubicación, tipo de plaga, y medidas correctivas. | - **Escenario 1:** Registro exitoso de plaga detectada <br>   **Dado** que se detecta una plaga en el almacén, <br>   **Cuando** se guarda la información en la base de datos, <br>   **Entonces** debe almacenarse un registro detallado con fecha, ubicación y acciones correctivas. <br> - **Escenario 2:** Consulta de historial de plagas <br>   **Dado** que se envía una solicitud GET para consultar el historial, <br>   **Entonces** debe devolver los registros históricos con un código 200. | EP07   |
| TS004  | Implementar Sección de Beneficios en la Landing Page | Como developer, necesito crear una sección en la landing page que muestre los beneficios de la plataforma de forma clara y visible para los visitantes. | - **Escenario 1:** Los beneficios se muestran exitosamente en la landing page. <br> **Dado** que el visitante está en la landing page, <br> **Cuando** carga la página, <br> **Entonces** debe ver los beneficios claramente en la sección correspondiente. <br> - **Escenario 2:** Beneficios destacados por relevancia. <br> **Dado** que hay múltiples beneficios, <br> **Cuando** el visitante desplaza la página, <br> **Entonces** los beneficios más relevantes deben estar destacados en la parte superior. | EP07   |
| TS005  | Crear Llamada a la Acción en la Landing Page   | Como developer, necesito implementar una llamada a la acción (CTA) que invite al visitante a registrarse o probar la plataforma.                   | - **Escenario 1:** La llamada a la acción es visible. <br> **Dado** que el visitante está en la landing page, <br> **Cuando** carga la página, <br> **Entonces** debe ver la CTA para registrarse de forma destacada. <br> - **Escenario 2:** La CTA cambia según la interacción. <br> **Dado** que el visitante pasa el mouse sobre la CTA, <br> **Cuando** se activa, <br> **Entonces** la CTA debe cambiar de color para atraer atención.                                       | EP07   |
| TS006  | Implementar Menú Lateral Navegable             | Como developer, necesito desarrollar un menú lateral que permita a los usuarios navegar por diferentes secciones de la aplicación.                 | - **Escenario 1:** Menú lateral visible. <br> **Dado** que el usuario está en la aplicación, <br> **Cuando** abre la aplicación, <br> **Entonces** debe ver un menú lateral con opciones de navegación. <br> - **Escenario 2:** El menú se cierra y abre correctamente. <br> **Dado** que el usuario está en la aplicación, <br> **Cuando** hace clic en el ícono de menú, <br> **Entonces** el menú lateral debe abrirse y cerrarse sin problemas.                                                    | EP07   |
| TS007  | Crear Vista de Configuración en la Barra Superior | Como developer, necesito implementar una vista de configuración en la barra superior para que los usuarios puedan modificar su cuenta.            | - **Escenario 1:** Acceso a configuración desde la barra superior. <br> **Dado** que el usuario está en la aplicación, <br> **Cuando** necesita cambiar la configuración de su cuenta, <br> **Entonces** puede acceder a la configuración desde la barra superior. <br> - **Escenario 2:** Cambios se guardan correctamente. <br> **Dado** que el usuario modifica su configuración, <br> **Cuando** hace clic en "Guardar", <br> **Entonces** los cambios deben ser confirmados y reflejados. | EP07   |
| TS008  | Crear API para Registro de Telas en el Inventario | Como developer, necesito implementar un endpoint que permita a los usuarios registrar nuevas telas en el inventario, incluyendo detalles como tipo, cantidad y ubicación. | - **Escenario 1:** Registro exitoso de tela. <br> **Dado** que el usuario proporciona todos los detalles necesarios, <br> **Cuando** envía una solicitud POST, <br> **Entonces** se crea un nuevo registro de tela en el inventario y devuelve un código 201. <br> - **Escenario 2:** Manejo de errores en el registro. <br> **Dado** que el usuario no proporciona todos los detalles necesarios, <br> **Cuando** envía la solicitud, <br> **Entonces** se devuelve un código de error 400 con un mensaje adecuado. | EP07   |
| TS009  | Implementar Filtros para Visualización de Inventario por Almacén | Como developer, necesito implementar filtros que permitan a los usuarios visualizar el inventario por almacén.                                    | - **Escenario 1:** Filtros aplicados correctamente. <br> **Dado** que el usuario está en la sección de inventario, <br> **Cuando** selecciona un almacén específico, <br> **Entonces** se muestran los productos disponibles de ese almacén. <br> - **Escenario 2:** Visualización sin filtros muestra todo el inventario. <br> **Dado** que el usuario está en la sección de inventario, <br> **Cuando** no aplica ningún filtro, <br> **Entonces** se muestran todos los productos de todos los almacenes.                | EP07   |
| TS010  | API para Configuración de Alertas de Temperatura y Humedad | Como developer, necesito implementar un servicio que permita configurar alertas para temperatura y humedad.                                       | - **Escenario 1:** Configuración exitosa de alertas. <br> **Dado** que el usuario está en la sección de gestión ambiental, <br> **Cuando** ingresa parámetros válidos para las alertas, <br> **Entonces** se guarda la configuración de manera exitosa. <br> - **Escenario 2:** Validación de parámetros incorrectos. <br> **Dado** que el usuario ingresa parámetros inválidos, <br> **Cuando** intenta guardar la configuración, <br> **Entonces** se muestra un mensaje de error adecuado.     | EP07   |
| TS011  | Monitoreo en Tiempo Real de Temperatura y Humedad | Como developer, necesito habilitar la visualización en tiempo real de los datos de temperatura y humedad para un almacén específico.              | - **Escenario 1:** Datos de temperatura y humedad se muestran en tiempo real. <br> **Dado** que el usuario está en la vista de monitoreo, <br> **Cuando** selecciona un almacén, <br> **Entonces** los datos de temperatura y humedad deben actualizarse en tiempo real. <br> - **Escenario 2:** Manejo de desconexiones. <br> **Dado** que la conexión a la fuente de datos se pierde, <br> **Cuando** esto ocurre, <br> **Entonces** debe mostrarse un mensaje de error y reintentar la conexión automáticamente. | EP07  |
| TS012  | Crear API para Registrar Almacenes y Sensores  | Como developer, necesito implementar un endpoint que permita registrar nuevos almacenes y sus sensores asociados.                                  | - **Escenario 1:** Registro exitoso de almacén y sensor. <br> **Dado** que el usuario proporciona todos los datos requeridos, <br> **Cuando** envía una solicitud POST, <br> **Entonces** se registra el nuevo almacén con el sensor en el sistema y devuelve un código 201. <br> - **Escenario 2:** Validación de datos faltantes en el registro. <br> **Dado** que el usuario omite datos obligatorios, <br> **Cuando** envía la solicitud, <br> **Entonces** se devuelve un código de error 400 con una descripción del problema. | EP07   |
| TS013  | Implementar Visualización de Almacenes y Sensores | Como developer, necesito crear una vista donde los usuarios puedan visualizar todos los almacenes y los sensores registrados en cada uno.         | - **Escenario 1:** Visualización de almacenes y sensores. <br> **Dado** que el usuario accede a la sección de almacenes, <br> **Cuando** visualiza la lista, <br> **Entonces** debe ver todos los almacenes y los sensores vinculados a cada uno. <br> - **Escenario 2:** Ordenar almacenes por nombre. <br> **Dado** que el usuario tiene la lista de almacenes visible, <br> **Cuando** selecciona la opción de ordenar por nombre, <br> **Entonces** la lista debe reorganizarse alfabéticamente. | EP07   |
...
<img src="resources/Impact map 1.png"/>
